...
consolidate and normalize ASHA-collected data,


run AI/ML models that detect high-risk patterns and missed follow‑ups, and


provide PHC and block-level dashboards that highlight the most vulnerable patients and villages.
